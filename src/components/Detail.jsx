...
const Detail = () => {
  ...
  return movieDiscription === null ? (
    <div className=" w-36 h-36 spin  rounded-full relative mx-auto top-36 animate-spin"></div>
  ) : (
    <div className="bg-black">
      <div className="flex justify-between">
        <div className="">
          <img src={logo} alt="logo" className="md:w-48 w-24 scale-110" />
        </div>
      ...
      <div className="md:w-4/5 py-6  mx-auto relative rounded ">
        <div className="w-full absolute z-10 md:mx-auto  h-[290px] md:h-[357px] "> </div>
        <VideoTrailer movieId={movieId.movieId} />
      </div>
      <div className="w-full h-screen bg-white object-cover">
        <img
          src={IMG_CDN + movieDiscription?.poster_path}
          alt="movies"
